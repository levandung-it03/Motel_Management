...
/*
import com.motel_management.Controllers.Controller_ContractList;
...
/*
        ...
        public void createContractListPage() {
            ...
            String[][] contracts = Controller_ContractList.getAllContract();
            String[] columns = {"Contract Code", "Number of People", "Maximum Quantity", "Default Contract Price", "Delete Button"};
            ...
            // Margin Table.
            this.contractScrollPane.setBorder(new EmptyBorder(20, 20, 0, Configs.centralPanelWidth/4));
